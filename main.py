...
print('To start, please enter your username and age')
...
print('Questions 2')
print('Who play as John Waaka? hint: He appeared in the Hunter of the wilderpeople')
...
print('Question 6')
print('What do you think of my game, rating out of 100?')
